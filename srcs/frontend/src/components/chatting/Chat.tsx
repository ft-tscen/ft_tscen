...
export function Chat({msg} :{ msg :Message }) {
    if (msg.name === "me") {
        return (
            <Row className="w-100 m-0 p-0 pt-1 h-auto justify-content-end">
        ...
        return (
            <Row className="w-100 m-0 p-0 pt-1 h-auto justify-content-centor">
        ...
        return (
            <Row className="w-100 m-0 p-0 pt-1 h-auto">
