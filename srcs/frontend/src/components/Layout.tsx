...
function Layout({
	...
	const getComponent = () => {
		if (param === "") {
			...
			return (
				<Game
					mod={gameMod.soloGame}
					isChangedGameData={isChangedData}
					setChangedGameData={setChangedData}
		...
		else if (param === "watchGame")
			return (
				<Game
					mod={gameMod.watchGame}
					isChangedGameData={isChangedData}
					setChangedGameData={setChangedData}
					SetNeedclear={SetNeedclear}
				/>
			...
			return <CreatRoom SetNeedclear={SetNeedclear} />;
		else navigate("/");
	};
